...
//			exit(1); // Exit to OS
//		}
//		memcpy(data, "Hello World!", size);
//		text_file_write_byte(data, size, file);
//		free(data);
//		text_file_close(file);
// 
// 
...
//			exit(1); // Exit to OS
//		}
//		if (text_file_read_byte(data, size, file))
//		{
...
bool text_file_write_byte(byte* data, i64 size, text_file file);
...
bool text_file_read_byte(byte* data, i64 size, text_file file);
